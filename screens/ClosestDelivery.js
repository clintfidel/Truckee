        ...
        <View style={styles.modalBody}>
          ...
          <View style={styles.location}>
            ...
            <View style={styles.to}>
              ...
              <Text style={styles.locationText2}>{getAddress()}</Text>
            </View>
          </View>
      ...
      <View style={styles.footer}>
        <View style={styles.buttonCont}>
          ...
          <View style={styles.acceptBtn}>
            <TouchableOpacity onPress={driverAcceptDeivery}>
...
export default connect(mapStateToProps, { getSingleDelivery, acceptDelivery })(
  Delivery
);
