...
import { TouchableOpacity, ScrollView, View, Dimensions, Text, StyleSheet, Image, Platform, Linking } from 'react-native';
import { Ionicons } from '@expo/vector-icons';
import * as Clipboard from 'expo-clipboard';
import box from "../assets/box.png";
import person from "../assets/person.png";
import { getSingleDelivery } from "../actions/deliveryAction";
import { connect } from "react-redux";

function Delivered({ navigation, singleDelivery }) {
  ...
  return (
      ...
      <View style={styles.header}>
        <View style={styles.topHeader}>
          <TouchableOpacity onPress={()=> navigation.navigate('DrawerNavigationRoutes', { screen: "All Delivery"})}>
      ...
      <ScrollView
        ...
        <View style={styles.activeDeliveryCont}>
          ...
          <Text style={styles.activeDeliveryDate}>Feb. 21, 2021 at 2:03 pm</Text>
        </View>
          ...
          <View style={styles.locationToFro}>
            <View style={styles.itemCont}>
              <View style={styles.deliveryItem}>
                <Text style={styles.locationText2}>256 Market Street, Lagos, Nigeria</Text>
                <TouchableOpacity onPress={copyToClipboard}>
                  <Ionicons style={styles.icon} size={20} name="copy" color="#CBCECF" />
                </TouchableOpacity>
              </View>
            </View>
            <View style={styles.itemCont}>
              <View style={styles.deliveryItem}>
                <Text style={styles.locationText2}>430 River Street, Lagos, Nigeria</Text>
                <TouchableOpacity onPress={copyToClipboard}>
                  <Ionicons style={styles.icon} size={20} name="copy" color="#CBCECF" />
                </TouchableOpacity>
              </View>
        ...
        <View style={styles.customerContactCont}>
          ...
          <View style={styles.customerNameCont}>
            <Ionicons style={styles.icon} size={20} name="person" color="#9CACBF" />
...
export default connect(mapStateToProps, { getSingleDelivery })(Delivered);
